  ...
  plans: [
    {
      ...
      features: [
        ...
        { label: "Local AES-256 encryption" },
        { label: "One seamless workflow from Pre-Op to Post-Op" },
        { label: "Fully functional offline" },
    ...
    },
    {
      ...
      features: [
        ...
        { label: "Export every case without limits" },
        { label: "Customize your workflow with unlimited snippets" },
